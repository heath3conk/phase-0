...
class Profile
 ...
 # the change_my_age= syntax might be confusing to see, it just allows us to set 
 # the value of the @age variable using = format instead of the standard argument format. 
 # Look at line 71 to see what I mean. The equals sign is just a part of the method name string, 
...
# I have to use p here because what_is_age only returns the value of @number, it does not print 
# anything to the console. The p modifier prints to the console whatever value is returned. Nifty!
puts "--- printing age -----"
...
sleep 0.8
instance_of_profile.print_info  #Let's see the final product now. We changed all of the values using 
# setters, so everything is different than before.
