...
What tests did you have trouble passing? What did you do to make it pass? Why did that work?
  The only serious difficulty I had was forgetting to put a semicolon after one of the lines. 
  It wasn't even the first line, so you'd think that meant I knew it needed to be there! I also
  mis-typed 'children' in line 26 and got hung up for a few minutes before I figured that out.

How difficult was it to add and delete properties outside of the object itself?
  It was pretty straightforward. I wasn't sure that I'd be able to string two different objects 
  together, as in line 26 but once I saw that it worked (after fixing the typo), it made sense.


What did you learn about manipulating objects in this challenge?
  I like the dot notation for changing/adding properties. It seems nice and clear. It's nice that
  you can add new properties that way too. I also think it's good to be able to delete properties 
  so easily.
